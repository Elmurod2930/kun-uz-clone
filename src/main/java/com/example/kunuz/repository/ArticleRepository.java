...
public interface ArticleRepository extends CrudRepository<ArticleEntity, String> {
    @Query(value = "select a from ArticleEntity a where type=:typeEntity order by createdDate limit :count", nativeQuery = true)
    List<ArticleEntity> findAllByType(@Param("typeEntity") ArticleTypeEntity typeEntity, @Param("count") Integer count);
